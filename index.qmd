...
![](./images/bruna-logo-cropped.png){fig-alt="Bruna Lab Logo - a stylized hummingbird visiting a flower"}
...
<a class="btn btn-primary" href="news/index.qmd" alt="button for news page" aria-label="button for lab news" role="button">The Bruna Lab in the News</a>
</p>
...
<!-- <a class="btn btn-primary" href="news/index.qmd" alt="button for news page" aria-label="button for lab news" role="button">Bruna Lab in the News</a> -->
<!-- ::: -->

<!-- ::: {#second-column} -->
<!-- ![](./images/bruna-logo-bird.png){fig-alt="Bruna Lab Logo - a stylized hummingbird visiting a flower"} -->
<!-- ::: -->
<!-- :::: -->
